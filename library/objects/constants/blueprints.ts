...
export const wheatProcessing = new Blueprint(
	...
	{ fullTimeEquivalent: 5000, buildingName: 'Mill' },
);
...
export const bronzeIngotProduction = new Blueprint(
	...
	{ fullTimeEquivalent: 5000, buildingName: 'Bronze foundry' },
);

import { Driver } from '../level-1/drivers/Driver';
import { DriverI } from '../level-1/drivers/types';
import { byEcsComponents } from '../level-1/ecs/assert';
...
import { DestroyerFn } from '../level-1/types';
